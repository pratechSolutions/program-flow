...
public enum ErrorType {
    ...
    REGISTRATION_NUMBER_ALREADY_EXISTS(1003, "Company registration number already exists.", NOT_ACCEPTABLE),
    TAX_NUMBER_ALREADY_EXISTS(1004, "Tax number already exists.", NOT_ACCEPTABLE),
